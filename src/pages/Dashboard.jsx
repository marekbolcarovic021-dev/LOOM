...
function Dashboard() {
  ...
  // ==================================================
  // IMPORTANT:
  // Net worth comes from the user's ACCOUNTS.
  // It is NOT calculated from transactions.
  //
  // This means a user can have €14,000 in their accounts
  // even if they have created zero transactions.
  // ==================================================
  ...
  // TRANSACTION TOTALS
  // ==================================================
  // Income and expenses are calculated ONLY from
  // transactions.
  // ==================================================
  ...
  // This is the transaction balance for the
  // savings-rate / financial-health calculations.
  //
  // It is NOT the user's net worth.
